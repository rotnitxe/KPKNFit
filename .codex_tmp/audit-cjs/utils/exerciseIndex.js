...
exports.buildExerciseIndex = buildExerciseIndex;
exports.findExercise = findExercise;
exports.findExerciseByPartialName = findExerciseByPartialName;
exports.findExerciseWithFallback = findExerciseWithFallback;
...
function buildExerciseIndex(exerciseList) {
    ...
    for (const [aliasId, canonicalId] of exerciseDatabaseMerged_1.EXERCISE_ID_ALIASES) {
