...
- The code and exported Room schema are authoritative when documentation disagrees. The current Room database is **v24**; some older docs still say v23/v20/v19.
