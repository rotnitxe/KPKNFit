...
- The code and exported Room schema are authoritative when documentation disagrees. The current Room database is **v25**; some older docs still say v24/v23/v20/v19.
