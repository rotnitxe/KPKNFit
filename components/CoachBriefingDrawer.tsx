  ...
  return (
    <WorkoutDrawer isOpen={isOpen} onClose={onClose} title="Informe Coach IA" height="85vh">
      <div className="p-5 flex flex-col items-center">
        <SparklesIcon size={40} className="text-orange-500/80 mb-4" />
        <p className="text-slate-300 whitespace-pre-wrap text-center font-mono text-sm leading-relaxed">{briefing}</p>
        <button onClick={onClose} className="mt-8 w-full py-4 rounded-xl bg-orange-500 text-white font-mono font-black text-[10px] uppercase tracking-widest hover:bg-orange-600 transition-colors border border-orange-400/30">
          Entendido, ¡vamos!
        </button>
      </div>
    </WorkoutDrawer>
