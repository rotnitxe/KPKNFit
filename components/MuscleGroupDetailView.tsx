            ...
            <header className="relative h-48 -mx-4 border-b border-cyber-cyan/20">
             ...
             <div className="space-y-6 mt-6 px-4">
                 ...
                 <div className="p-4 rounded-xl border border-cyber-cyan/20 bg-[#0a0a0a]">
                    ...
                    {!wikiExtract && (
                        <button
                            ...
                            className="mt-3 text-xs text-cyber-cyan/90 hover:text-cyber-cyan font-medium disabled:opacity-50 disabled:cursor-wait"
                        >
                ...
                {childMuscleInfos.length > 0 && (
                    <details className="rounded-xl border border-cyber-cyan/20 overflow-hidden" open>
                    ...
                    <div className="p-4 rounded-xl border border-cyber-cyan/20 bg-[#0a0a0a]">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {muscleInfo.relatedJoints?.map(jId => {
                                ...
                                return (
                                    <button key={jId} onClick={() => navigateTo('joint-detail', { jointId: jId })} className="px-3 py-1.5 bg-cyber-cyan/10 border border-cyber-cyan/30 rounded-lg text-xs font-mono text-cyber-cyan/90 hover:bg-cyber-cyan/20 hover:border-cyber-cyan/50 transition-colors">
                                        {label}
                                    </button>
                                );
                            })}
                    ...
                    <div className="p-4 rounded-xl border border-cyber-cyan/20 bg-[#0a0a0a]">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {muscleInfo.relatedTendons?.map(tId => {
                                ...
                                return (
                                    <button key={tId} onClick={() => navigateTo('tendon-detail', { tendonId: tId })} className="px-3 py-1.5 bg-cyber-cyan/10 border border-cyber-cyan/30 rounded-lg text-xs font-mono text-cyber-cyan/90 hover:bg-cyber-cyan/20 hover:border-cyber-cyan/50 transition-colors">
                                        {label}
                                    </button>
                                );
                            })}
