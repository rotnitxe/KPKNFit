...
const BackgroundEditorModal: React.FC<BackgroundEditorModalProps> = ({
    ...
    const handleUpdateCoverFilter = (filter: keyof NonNullable<CoverStyle['filters']>, value: number) => {
        setCoverStyle(prev => ({
            ...prev,
        ...
        <>
            ...
            <TacticalModal isOpen={isOpen} onClose={onClose} title="Prime Art Studio" className="!max-w-2xl !bg-slate-950">
                <div className="flex flex-col h-[75vh]">
                    ...
                    {/* --- PREVIEW AREA (Top) --- */}
                    <div className="flex-shrink-0 relative w-full aspect-video bg-black rounded-xl overflow-hidden shadow-2xl mb-4 border border-[#E6E0E9] group">
                        {currentCoverImage ? (
                            <>
                                <div
                    ...
                    <div className="flex-grow flex flex-col min-h-0 bg-slate-900/50 rounded-xl border border-[#E6E0E9] overflow-hidden">

                        {/* Mode Tabs */}
                        <div className="flex border-b border-[#E6E0E9]">
                        ...
                        <div className="flex-grow overflow-y-auto p-4 custom-scrollbar">
                            ...
                            {editTab === 'background' && (
                                <div className="space-y-6">
                                    <div className="flex items-center justify-between p-3 bg-white/5 rounded-xl border border-[#E6E0E9]">
                    ...
                    {/* --- ACTION FOOTER --- */}
                    <div className="mt-4 flex gap-3 pt-4 border-t border-[#E6E0E9]">
