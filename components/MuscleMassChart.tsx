...
const MuscleMassChart: React.FC = () => {
    ...
    return (
        <Card>
            <h3 className="text-xl font-bold mb-4">Evolución % Masa Muscular</h3>
