    ...
    <div className="pb-[max(120px,calc(90px+env(safe-area-inset-bottom,0px)+24px))] animate-fade-in bg-[#0a0a0a] min-h-screen">
      <header className="relative h-32 -mx-4 bg-gradient-to-b from-cyber-cyan/30 to-[#0a0a0a] border-b border-cyber-cyan/20">
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <span className="text-cyber-cyan/90 text-[10px] font-mono font-black uppercase tracking-widest">{typeLabel}</span>
      ...
      <div className="space-y-6 mt-6 px-4">
        ...
        {relatedMuscles.length > 0 && (
          <div className="p-4 rounded-xl border border-cyber-cyan/20 bg-[#0a0a0a]">
            <h3 className="text-[10px] font-mono font-black uppercase tracking-widest text-cyber-cyan/90 mb-3">Músculos que la cruzan</h3>
        ...
        {protectiveExercises.length > 0 && (
          <div className="p-4 rounded-xl border border-cyber-cyan/20 bg-[#0a0a0a]">
            ...
            <p className="text-xs text-slate-400 mb-3">Isométricos, movilidad y ejercicios de rehabilitación recomendados para esta articulación.</p>
            <div className="space-y-2">
