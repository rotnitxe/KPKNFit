...
const WizardLayout: React.FC<WizardLayoutProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-black/70 text-white flex flex-col overflow-hidden">
            ...
            />
            {/* Top Bar */}
            <div className="relative z-10 flex items-center justify-between px-4 py-2.5 border-b border-white/10 bg-black/25 backdrop-blur-md shrink-0">
            ...
            <div className="relative z-10 flex-1 flex overflow-hidden min-h-0">
                ...
                <div className="hidden sm:block w-[280px] shrink-0 border-l border-white/5 bg-black/20 backdrop-blur-sm">
                    <ProgramPreviewPanel
            ...
            {previewOpen && (
                <div className="sm:hidden fixed inset-x-0 bottom-0 z-50 bg-black/70 backdrop-blur-xl border-t border-white/10 rounded-t-2xl max-h-[50vh] overflow-y-auto custom-scrollbar animate-slide-up shadow-2xl">
