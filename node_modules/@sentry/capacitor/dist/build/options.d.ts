 ...
 */
export interface CapacitorOptions extends Omit<BrowserOptions, '_experiments' | 'enableMetrics'>, BaseCapacitorOptions {
}
export interface CapacitorTransportOptions extends BrowserTransportOptions {
}
export interface CapacitorClientOptions extends Omit<ClientOptions<CapacitorTransportOptions>, '_experiments' | 'enableMetrics'>, BaseCapacitorOptions {
}
export {};
