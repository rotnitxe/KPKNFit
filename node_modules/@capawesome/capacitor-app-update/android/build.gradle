ext {
    ...
    androidPlayAppUpdateVersion = project.hasProperty('androidPlayAppUpdateVersion') ? rootProject.ext.androidPlayAppUpdateVersion : '2.1.0'
...
android {
    namespace "io.capawesome.capacitorjs.plugins.appupdate"
