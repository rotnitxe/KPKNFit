...
public class KpknVolumeWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int id : appWidgetIds) KpknWidgetHelper.updateVolumeWidget(context, appWidgetManager, id);
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        int[] ids = manager.getAppWidgetIds(new ComponentName(context, KpknVolumeWidgetProvider.class));
