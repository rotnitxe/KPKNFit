...
export const PORTION_REFERENCES: PortionRefEntry[] = [
    ...
    { key: 'teaspoon', label: 'Una cucharadita', description: 'Cucharita de postre o té', gramsByFoodType: { protein: 5, carb: 4, fat: 5, sugar: 4, puree: 6, liquid: 5, rehydratable: 2, mixed: 5 } },
    { key: 'glass', label: 'Un vaso', description: 'Vaso estándar (~200-250 ml)', gramsByFoodType: { protein: 200, carb: 200, fat: 200, sugar: 200, puree: 250, liquid: 250, rehydratable: 40, mixed: 220 } },
    { key: 'slice', label: 'Una rebanada', description: 'Tajada, lámina o rebanada', gramsByFoodType: { protein: 30, carb: 35, fat: 15, sugar: 20, puree: 15, liquid: 0, rehydratable: 0, mixed: 30 } },
    { key: 'can', label: 'Una lata', description: 'Lata estándar / conservas', gramsByFoodType: { protein: 120, carb: 150, fat: 150, sugar: 330, puree: 150, liquid: 330, rehydratable: 100, mixed: 150 } },
    { key: 'portion', label: 'Una porción', description: 'Equivalente estándar o porción comercial', gramsByFoodType: { protein: 100, carb: 100, fat: 30, sugar: 30, puree: 50, liquid: 200, rehydratable: 30, mixed: 100 } },
    { key: 'scoop', label: 'Un scoop', description: 'Medida dosificadora estándar (proteína/suplementos)', gramsByFoodType: { protein: 30, carb: 30, fat: 20, sugar: 30, puree: 30, liquid: 20, rehydratable: 15, mixed: 30 } },
];
