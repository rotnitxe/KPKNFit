...
export const TERMINOLOGY: Record<string, string> = {
    ...
    'Repeticiones Totales': 'Suma total de repeticiones realizadas para un levantamiento específico en la semana (Σ Series x Reps). Es una medida cruda del volumen total y se usa para monitorear el volumen mínimo y máximo recomendado por grupo muscular.',
