...
export const INITIAL_MUSCLE_GROUP_DATA: MuscleGroupInfo[] = [
    ...
    { id: 'glúteo-mayor', name: 'Glúteo Mayor', description: 'El músculo más grande y fuerte del cuerpo. Su función principal es la extensión de la cadera.', importance: { movement: 'Potencia movimientos como sentadillas, peso muerto, hip thrusts y sprints.', health: 'Esencial para la estabilidad pélvica y la fuerza general.'}, volumeRecommendations: { mev: '4', mav: '8-12', mrv: '16' }, origin: 'Ilion, sacro, cóccix', insertion: 'Tuberosidad glútea del fémur y tracto iliotibial', mechanicalFunctions: ['Extensión de cadera', 'Rotación externa de cadera', 'Abducción (porción superior)'], relatedJoints: ['cadera', 'sacroiliaca'], relatedTendons: [], commonInjuries: [{ name: 'Síndrome del piramidal', description: 'Puede confundirse con dolor glúteo.', returnProgressions: ['Hip thrust', 'Puente de glúteo'] }], movementPatterns: ['hinge', 'squat', 'extension'] },
