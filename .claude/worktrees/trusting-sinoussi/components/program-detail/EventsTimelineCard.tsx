                ...
                <div className="px-4 pb-4 space-y-4 animate-fade-in">
                            ...
                            <div className="relative w-40 h-40 flex items-center justify-center">
                                ...
                                {events.map((ev, i) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="w-10 h-10 rounded-full bg-[#FEF7FF] border border-yellow-500/50 flex items-center justify-center shadow-[0_0_10px_rgba(250,204,21,0.2)] group-hover:scale-110 transition-all">
                                                <div className="text-center">
                                                    <span className="block text-[7px] text-[#49454F] font-black uppercase leading-none">Cada</span>
                                                    <span className="block text-[10px] font-black text-yellow-400 leading-none mt-0.5">{ev.repeatEveryXCycles}</span>
                                                </div>
                                            </div>
                                            <div className="absolute top-11 bg-black px-2 py-1 rounded-md border border-[#E6E0E9] min-w-max pointer-events-none">
                    ...
                    {events.length > 0 ? (
                        <div className="flex gap-2 overflow-x-auto no-scrollbar pb-1">
                            {events.map((e, idx) => (
                                <div key={idx} className="relative shrink-0 w-40 bg-[#FEF7FF] border border-[#E6E0E9] rounded-xl p-3 flex flex-col group hover:border-white/30 transition-colors">
                                    <button
                                        onClick={ev => {
                                            ev.stopPropagation();
                        ...
                        <div className="w-full text-center py-6 border border-dashed border-[#E6E0E9] rounded-xl bg-black/20">
                            <p className="text-[9px] text-[#49454F] uppercase font-bold tracking-widest">Sin eventos programados.</p>
                        </div>
                    )}
