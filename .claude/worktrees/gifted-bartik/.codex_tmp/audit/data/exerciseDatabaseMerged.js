...
const merged = [...UPPER_BODY_EXERCISES, ...LOWER_BODY_EXERCISES, ...ULTIMO_LOTE_EXERCISES];
...
export const EXERCISE_ID_ALIASES = fullAliasMap;
export const FULL_EXERCISE_LIST = nameDeduped.map(enrichWithOperationalData);
