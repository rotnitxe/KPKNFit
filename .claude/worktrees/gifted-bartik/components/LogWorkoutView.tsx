...
const WorkoutHeader: React.FC<{
    ...
    <div className="sticky top-0 z-30 bg-[var(--bg-color)] pb-3 animate-fade-in-down" style={{ paddingTop: 'max(16px, env(safe-area-inset-top, 24px))' }}>
        ...
        <div className="pb-10">
            ...
            {historyModalExercise && (
                <ExerciseHistoryModal
                    exerciseName={historyModalExercise.name} history={history}
