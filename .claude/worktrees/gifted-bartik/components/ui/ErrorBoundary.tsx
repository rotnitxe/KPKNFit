...
class ErrorBoundary extends Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
            ...
            <div className="bg-zinc-900/80 backdrop-blur-xl border border-red-500/30 p-5 rounded-2xl max-w-sm w-full shadow-xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#49454F] font-bold">Copia el error y envíalo a tu IA para solucionarlo.</p>
                </div>
              </div>

              <div className="bg-black rounded-xl p-3 mb-4 overflow-auto max-h-32 border border-[#E6E0E9] text-[9px] font-mono text-[#49454F]">
      ...
      return (
        <div className="min-h-screen bg-[#FEF7FF] flex flex-col items-center justify-center p-6 text-white font-sans absolute inset-0 z-[9999]">
          <div className="bg-zinc-900/80 backdrop-blur-xl border border-red-500/30 p-6 rounded-3xl max-w-md w-full shadow-2xl shadow-red-500/10">
            <div className="flex flex-col items-center text-center mb-6">
              ...
              <p className="text-[11px] text-[#49454F] font-bold uppercase tracking-widest mt-2 leading-relaxed">
                Hemos interceptado una falla crítica.<br/>Copia el error y envíaselo a tu IA.
              </p>
            </div>

            <div className="bg-black rounded-2xl p-4 mb-6 overflow-auto max-h-48 border border-[#E6E0E9] text-[10px] font-mono text-[#49454F] relative">
            ...
            <div className="flex flex-col gap-3">
              <button 
                ...
                className={`w-full py-4 rounded-xl flex items-center justify-center gap-2 text-[11px] font-black uppercase tracking-widest transition-all ${this.state.copied ? 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/30' : 'bg-zinc-800 text-white border border-[#E6E0E9] hover:bg-zinc-700'}`}
              >
                {this.state.copied ? (
