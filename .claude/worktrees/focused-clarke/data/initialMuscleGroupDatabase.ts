...
export const INITIAL_MUSCLE_GROUP_DATA: MuscleGroupInfo[] = [
    // --- CATEGORÍAS PRINCIPALES ---
    {
        ...
        aestheticImportance: 'El pectoral define la parte frontal del torso. Un pecho desarrollado aporta anchura y profundidad al upper body, creando la silueta en "V". La porción superior (clavicular) es especialmente visible con camiseta y aporta definición al escote.',
    },
    {
        id: 'espalda',
        name: 'Espalda',
    ...
    // Pecho
    { id: 'pectoral-superior', name: 'Pectoral Superior', description: 'La porción clavicular del pectoral, responsable de la flexión y aducción del hombro en ángulos elevados.', importance: { movement: 'Crucial para empujes inclinados y levantar objetos por encima de la cabeza.', health: 'Un desarrollo equilibrado con el resto del pectoral es clave para la estética y la salud del hombro.'}, volumeRecommendations: { mev: '4-6', mav: '10-12', mrv: '15' }, origin: 'Mitad medial de la clavícula', insertion: 'Cresta del tubérculo mayor del húmero', mechanicalFunctions: ['Flexión del hombro', 'Aducción horizontal', 'Rotación interna'], relatedJoints: ['glenohumeral'], relatedTendons: [], commonInjuries: [{ name: 'Tirón pectoral', description: 'Desgarro de las fibras del pectoral por sobrecarga.', riskExercises: ['db_bench_press_tng', 'db_dips'], contraindications: ['Evitar cargas máximas en fase aguda'], returnProgressions: ['Press con banda', 'Flexiones', 'Progresión a press'] }], movementPatterns: ['horizontal-push', 'vertical-push'] },
    { id: 'pectoral-medio', name: 'Pectoral Medio', description: 'La porción esternal del pectoral, la más grande y fuerte. Es la principal responsable de la aducción horizontal del brazo (abrazar).', importance: { movement: 'Motor principal en el press de banca plano y otros empujes horizontales.', health: 'Fundamental para la fuerza de empuje general.'}, volumeRecommendations: { mev: '6', mav: '10-16', mrv: '20' }, origin: 'Esternón y cartílagos costales', insertion: 'Cresta del tubérculo mayor del húmero', mechanicalFunctions: ['Aducción horizontal', 'Flexión del hombro', 'Rotación interna'], relatedJoints: ['glenohumeral'], relatedTendons: [], commonInjuries: [{ name: 'Tirón pectoral', description: 'Desgarro de las fibras del pectoral.', riskExercises: ['db_bench_press_tng'], contraindications: ['Evitar cargas máximas'], returnProgressions: ['Progresión gradual'] }], movementPatterns: ['horizontal-push'] },
    ...
    // Espalda
    { id: 'dorsal-ancho', name: 'Dorsal Ancho', description: 'El músculo más grande de la espalda, responsable de la aducción, extensión y rotación interna del brazo. Da la "amplitud" a la espalda.', importance: { movement: 'Es el motor principal en movimientos de tracción vertical como las dominadas y la escalada.', health: 'Contribuye a la estabilidad de la columna y la articulación del hombro.'}, volumeRecommendations: { mev: '8', mav: '12-18', mrv: '22' }, aestheticImportance: 'El dorsal ancho es el motor principal de la anchura de espalda. Da la forma en "V" al torso: cuanto más desarrollado, más anchura visual y mejor proporción con la cintura. Es uno de los músculos más impactantes en la estética del cuerpo.', origin: 'Apófisis espinosas T7-L5, cresta ilíaca, costillas inferiores', insertion: 'Surco intertubercular del húmero', mechanicalFunctions: ['Aducción del hombro', 'Extensión del hombro', 'Rotación interna', 'Depresión escapular'], relatedJoints: ['glenohumeral', 'escapulotoracica'], relatedTendons: [], commonInjuries: [{ name: 'Tirón de dorsal', description: 'Desgarro de las fibras del dorsal.', riskExercises: ['db_pull_up', 'db_lat_pulldown'], returnProgressions: ['Remo con banda', 'Progresión a dominadas'] }], movementPatterns: ['vertical-pull', 'horizontal-pull'] },
    ...
    // Hombros
    { id: 'deltoides-anterior', name: 'Deltoides Anterior', description: 'La cabeza frontal del hombro. Es responsable de la flexión y rotación interna del brazo.', importance: { movement: 'Principal motor en los presses verticales y actor secundario en los presses horizontales.', health: 'Suele estar sobre-desarrollado en comparación con las otras cabezas, lo que puede causar desbalances posturales.'}, volumeRecommendations: { mev: '0-4', mav: '6-10', mrv: '12' }, origin: 'Tercio lateral de la clavícula', insertion: 'Tubérculo deltoideo del húmero', mechanicalFunctions: ['Flexión del hombro', 'Rotación interna', 'Aducción horizontal'], relatedJoints: ['glenohumeral'], relatedTendons: [], commonInjuries: [{ name: 'Impingement', description: 'Suele asociarse a desbalances con el deltoides posterior.', returnProgressions: ['Face pulls', 'Press con agarre neutro'] }], movementPatterns: ['horizontal-push', 'vertical-push'] },
    ...
    { id: 'supraespinoso', name: 'Supraespinoso', description: 'Músculo del manguito rotador ubicado en la fosa supraespinosa. Inicia la abducción del hombro (primeros 15°) y estabiliza la cabeza humeral.', importance: { movement: 'Clave en la elevación del brazo y la estabilidad del hombro. Muy susceptible a tendinopatía e impingement.', health: 'Su tendón es el más afectado en el síndrome subacromial.'}, volumeRecommendations: { mev: '0', mav: '4-8', mrv: '12' }, origin: 'Fosa supraespinosa de la escápula', insertion: 'Tubérculo mayor del húmero', mechanicalFunctions: ['Abducción del hombro', 'Estabilización glenohumeral'], relatedJoints: ['glenohumeral'], relatedTendons: ['tendon-supraespinoso'], commonInjuries: [{ name: 'Tendinopatía del supraespinoso', description: 'Degeneración del tendón por sobreuso o impingement.', riskExercises: ['db_bench_press_tng', 'db_overhead_press'], returnProgressions: ['Rotaciones externas', 'Face pulls', 'Progresión a press'] }] },
    { id: 'infraespinoso', name: 'Infraespinoso', description: 'Músculo del manguito rotador en la fosa infraespinosa. Principal rotador externo del hombro.', importance: { movement: 'Fundamental para la rotación externa y la estabilidad posterior del hombro.', health: 'Desbalances con el subescapular pueden causar inestabilidad.'}, volumeRecommendations: { mev: '0', mav: '4-8', mrv: '12' }, origin: 'Fosa infraespinosa de la escápula', insertion: 'Tubérculo mayor del húmero', mechanicalFunctions: ['Rotación externa del hombro', 'Estabilización glenohumeral'], relatedJoints: ['glenohumeral'], relatedTendons: ['tendon-infraespinoso'], commonInjuries: [{ name: 'Tendinopatía del infraespinoso', description: 'Suele asociarse a desbalances de rotadores.', riskExercises: ['db_bench_press_tng'], returnProgressions: ['Rotaciones externas', 'Face pulls'] }] },

    // Brazos
    { id: 'bíceps', name: 'Bíceps', description: 'El bíceps braquial, ubicado en la parte frontal del brazo. Está compuesto por una cabeza larga y una corta, y su función principal es la flexión del codo y la supinación del antebrazo.', importance: { movement: 'Esencial para todos los movimientos de tracción y para levantar objetos.', health: 'Contribuye a la estabilidad de la articulación del codo.'}, volumeRecommendations: { mev: '8', mav: '14-20', mrv: '22' }, aestheticImportance: 'El bíceps es el músculo más visible del brazo en flexión y uno de los más populares en culturismo. El "pico" del bíceps (cabeza larga) y el grosor (cabeza corta) definen la estética del brazo. Contribuye a la simetría y proporción del tren superior.', origin: 'Cabeza larga: tubérculo supraglenoideo. Cabeza corta: apófisis coracoidea', insertion: 'Tuberosidad radial', mechanicalFunctions: ['Flexión del codo', 'Supinación del antebrazo', 'Flexión del hombro (cabeza larga)'], relatedJoints: ['codo', 'glenohumeral'], relatedTendons: ['tendon-bíceps', 'tendon-bíceps-largo'], commonInjuries: [{ name: 'Tendinopatía del bíceps', description: 'Dolor en el tendón del bíceps.', riskExercises: ['db_barbell_curl'], returnProgressions: ['Curl martillo', 'Progresión a curl'] }], movementPatterns: ['horizontal-pull', 'vertical-pull'] },
    ...
    { id: 'tríceps', name: 'Tríceps', description: 'El tríceps braquial ocupa toda la parte posterior del brazo y tiene tres cabezas (larga, lateral, medial). Es el principal extensor del codo.', importance: { movement: 'Es el músculo principal en todos los movimientos de empuje (presses). Constituye aproximadamente 2/3 de la masa del brazo.', health: 'Fundamental para la estabilidad del codo y la fuerza de bloqueo.'}, volumeRecommendations: { mev: '6', mav: '10-14', mrv: '18' }, aestheticImportance: 'El tríceps representa ~2/3 de la masa del brazo. Da grosor y anchura vista de lado. La forma de "herradura" (cabeza lateral) es muy visible y la cabeza larga aporta masa en la parte posterior. Un tríceps desarrollado es clave para brazos completos.' },
    ...
    // Piernas
    { id: 'cuádriceps', name: 'Cuádriceps', description: 'Grupo de cuatro músculos en la parte frontal del muslo. Su función principal es la extensión de la rodilla.', importance: { movement: 'Esencial para levantarse de una silla, subir escaleras, correr y saltar.', health: 'Unos cuádriceps fuertes son vitales para la estabilidad y salud de la articulación de la rodilla.'}, volumeRecommendations: { mev: '6', mav: '10-15', mrv: '18' }, origin: 'Ilion (recto femoral), fémur (vastos)', insertion: 'Tuberosidad tibial vía tendón rotuliano', mechanicalFunctions: ['Extensión de rodilla', 'Flexión de cadera (recto femoral)'], relatedJoints: ['rodilla', 'cadera'], relatedTendons: ['tendon-rotuliano', 'tendon-cuádriceps'], commonInjuries: [{ name: 'Tendinopatía rotuliana', description: 'Dolor en el tendón por debajo de la rótula.', riskExercises: ['db_squat_high_bar'], returnProgressions: ['Sentadilla isométrica', 'Excéntricos', 'Progresión'] }], movementPatterns: ['squat', 'extension', 'lunge'] },
    ...
    { id: 'glúteo-mayor', name: 'Glúteo Mayor', description: 'El músculo más grande y fuerte del cuerpo. Su función principal es la extensión de la cadera.', importance: { movement: 'Potencia movimientos como sentadillas, peso muerto, hip thrusts y sprints.', health: 'Esencial para la estabilidad pélvica y la fuerza general.'}, volumeRecommendations: { mev: '4', mav: '8-12', mrv: '16' }, aestheticImportance: 'Los glúteos son uno de los grupos más visibles y deseados estéticamente. Un glúteo mayor desarrollado aporta forma, redondez y proyección trasera. Define la silueta inferior y la proporción cadera-cintura.' , origin: 'Ilion, sacro, cóccix', insertion: 'Tuberosidad glútea del fémur y tracto iliotibial', mechanicalFunctions: ['Extensión de cadera', 'Rotación externa de cadera', 'Abducción (porción superior)'], relatedJoints: ['cadera', 'sacroiliaca'], relatedTendons: [], commonInjuries: [{ name: 'Síndrome del piramidal', description: 'Puede confundirse con dolor glúteo.', returnProgressions: ['Hip thrust', 'Puente de glúteo'] }], movementPatterns: ['hinge', 'squat', 'extension'] },
    ...
    { id: 'gastrocnemio', name: 'Gastrocnemio', description: 'La parte más visible y superficial de la pantorrilla. Es un músculo biarticular que cruza la rodilla y el tobillo.', importance: { movement: 'Potente flexor plantar, especialmente con la pierna extendida. Contribuye a la potencia en saltos.', health: 'Suele acortarse, lo que puede afectar la movilidad del tobillo.'}, volumeRecommendations: { mev: '4-6', mav: '8-12', mrv: '16' }, origin: 'Cóndilos femorales (cabeza medial y lateral)', insertion: 'Calcáneo vía tendón de Aquiles', mechanicalFunctions: ['Flexión plantar', 'Flexión de rodilla'], relatedJoints: ['tobillo', 'rodilla'], relatedTendons: ['tendon-aquiles'], commonInjuries: [{ name: 'Tendinopatía aquílea', description: 'Degeneración del tendón de Aquiles.', riskExercises: ['Elevación de talones'], returnProgressions: ['Excéntricos de sóleo', 'Progresión'] }], movementPatterns: ['extension', 'jump'] },
