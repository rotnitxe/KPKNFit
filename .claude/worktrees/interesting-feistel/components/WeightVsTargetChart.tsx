        ...
        <Card>
            ...
            <ResponsiveContainer width="100%" height={250}>
                <LineChart data={chartData}>
                    ...
                    {(chartData[0] as any)['Línea de Objetivo'] && <Line type="monotone" dataKey="Línea de Objetivo" stroke="#a855f7" strokeWidth={2} strokeDasharray="5 5" isAnimationActive={true} animationDuration={800} />}
                </LineChart>
            </ResponsiveContainer>
        </Card>
    );
