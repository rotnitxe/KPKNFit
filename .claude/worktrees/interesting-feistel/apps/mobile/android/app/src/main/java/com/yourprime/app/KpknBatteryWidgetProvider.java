...
public class KpknBatteryWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int id : appWidgetIds) KpknWidgetHelper.updateBatteryWidget(context, appWidgetManager, id);
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        int[] ids = manager.getAppWidgetIds(new ComponentName(context, KpknBatteryWidgetProvider.class));
