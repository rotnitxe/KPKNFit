...
class ProgramTemplateCompositionContractTest {
    ...
    fun example_a_b_c_are_literal_cases() {
        ...
        assertEquals(CatalogIds.BP, squat.slots[2].lift.configurationId)
        assertEquals(com.example.kpkn.data.protocols.TechniqueModifier.PAUSE_2S, squat.slots[2].technique)
