...
class NutritionMetricsContractTest {
    ...
    private val identityCorpus: List<IdentityCase> = listOf(
        ...
        IdentityCase("arroz", "arroz", expectedId = "gen005", expectedStatus = FoodResolutionStatus.AUTO),
        IdentityCase("avena", "avena", expectedId = "gen011", expectedStatus = FoodResolutionStatus.AUTO),
