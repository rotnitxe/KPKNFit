...
object CardioCatalog {
    val items: List<CardioCatalogItem> = listOf(
        ...
        CardioCatalogItem("cardio_run_outdoor", "Carrera exterior", CardioType.RUN_OUTDOOR, "Carrera con distancia y GPS opcional.", requiresGps = true),
        CardioCatalogItem("cardio_bike_outdoor", "Bicicleta exterior", CardioType.BIKE_OUTDOOR, "Ciclismo exterior con GPS opcional.", requiresGps = true),
        CardioCatalogItem("cardio_walk", "Caminata", CardioType.WALK, "Caminata continua o por intervalos.", requiresGps = true),
