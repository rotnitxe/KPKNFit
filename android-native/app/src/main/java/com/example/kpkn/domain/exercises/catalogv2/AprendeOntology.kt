...
object AprendeOntology {
    ...
    /** Every catalog movement-pattern id is mapped to one atlas pattern. */
    val catalogPatternToWikiLab: Map<String, String> = mapOf(
        "ankle_dorsiflexion" to "extension",
        ...
        "biarticular_lengthened" to "extension",
        "deadlift" to "hinge",
        "diagonal_push" to "horizontal-push",
        "eccentric_knee_flexion" to "extension",
        "elbow_extension" to "extension",
        "elbow_flexion" to "extension",
        "hip_abduction" to "extension",
        "hip_abduction_extension" to "extension",
        "hip_abduction_external_rotation" to "extension",
        "hip_abduction_stability" to "anti-rotation",
        "hip_adduction" to "extension",
        "hip_adduction_dynamic" to "extension",
        "hip_extension" to "hinge",
        "hip_extension_abduction" to "hinge",
        "hip_extension_external_rotation" to "hinge",
        "hip_flexion" to "extension",
        "hip_hinge" to "hinge",
        "hip_hinge_deficit" to "hinge",
        "hip_hinge_explosive" to "hinge",
        "hip_hinge_lengthened" to "hinge",
        "horizontal_abduction" to "horizontal-pull",
        "horizontal_pull" to "horizontal-pull",
        "horizontal_push" to "horizontal-push",
        "isometric_grip" to "carry",
        "knee_dominant" to "squat",
        "knee_dominant_asymmetric" to "lunge",
        "knee_dominant_lengthened" to "squat",
        "knee_extension" to "extension",
        "knee_flexion" to "extension",
        "knee_hip_dominant" to "squat",
        "knee_hip_extension" to "squat",
        "knee_hip_flexion" to "squat",
        "lateral_knee_dominant" to "lunge",
        "lateral_trunk_flexion" to "extension",
        "neck_extension" to "extension",
        "neck_flexion" to "extension",
        "neck_lateral_flexion" to "extension",
        "pinch_grip" to "carry",
        "plantar_flexion" to "extension",
        "romanian_deadlift" to "hinge",
        "romanian_deadlift_deficit" to "hinge",
        "scapular_depression" to "extension",
        "scapular_elevation" to "extension",
        "shoulder_abduction_diagonal" to "extension",
        "shoulder_abduction_full_rom" to "extension",
        "shoulder_flexion" to "extension",
        "spinal_extension" to "extension",
        "spinal_flexion" to "extension",
        "trunk_flexion" to "extension",
        ...
        "vertical_pull_abduction" to "vertical-pull",
        "vertical_push" to "vertical-push",
        "wrist_extension" to "extension",
        "wrist_flexion" to "extension",
        "wrist_flexion_extension" to "extension",
    )
