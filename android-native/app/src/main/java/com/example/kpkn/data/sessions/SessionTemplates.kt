        ...
        session = Session(
            ...
            parts = listOf(
                part("p-push-1", "Pecho", "#1B4965", listOf(
                    ...
                    ex("p1-ex2", "Press Inclinado con Mancuernas", "tren_superior_press_banca_inclinado_barra",
                ...
                part("p-push-2", "Hombros", "#4A1942", listOf(
                    ex("p2-ex1", "Press Militar con Mancuernas", "tren_superior_press_militar_pie_barra",
        ...
        session = Session(
            ...
            parts = listOf(
                ...
                part("p-pull-2", "Espalda horizontal", "#244B3C", listOf(
                    ex("pu2-ex1", "Remo con Barra / Remo Pendlay", "ultimo_remo_barra_esquina_1_brazo",
                        nSets("pu2e1", 4, 8, 8.0), restTime = 150),
                    ex("pu2-ex2", "Remo en Polea Baja", "tren_superior_remo_inclinado_prono_barra",
                ...
                part("p-pull-3", "Bíceps", "#5B2A86", listOf(
                    ex("pu3-ex1", "Curl con Barra EZ", "tren_superior_curl_biceps_barra_recta",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-lh-1", "Bisagra de Cadera", "#244B3C", listOf(
                    ...
                    ex("lh1-ex2", "Peso Muerto con Piernas Rígidas", "tren_inferior_peso_muerto_rumano",
                ...
                part("p-lh-2", "Glúteos e Isquios", "#1B4965", listOf(
                    ...
                    ex("lh2-ex3", "Abducción de Cadera en Máquina", "tren_inferior_hip_thrust_barra",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-ua-1", "Pecho + Espalda", "#1B4965", listOf(
                    ...
                    ex("ua1-ex2", "Remo con Barra", "ultimo_remo_barra_esquina_1_brazo",
                        nSets("ua1e2", 4, 8, 8.0), restTime = 150),
                    ex("ua1-ex3", "Press Inclinado con Mancuernas", "tren_superior_press_banca_inclinado_barra",
                ...
                part("p-ua-2", "Hombros + Brazos", "#5B2A86", listOf(
                    ex("ua2-ex1", "Press Militar con Mancuernas", "tren_superior_press_militar_pie_barra",
                    ...
                    ex("ua2-ex3", "Curl con Barra EZ", "tren_superior_curl_biceps_barra_recta",
        ...
        session = Session(
            ...
            parts = listOf(
                ...
                part("p-fb-3", "Tirón", "#244B3C", listOf(
                    ex("fb3-ex1", "Remo con Barra / Jalón al Pecho", "ultimo_remo_barra_esquina_1_brazo",
        ...
        session = Session(
            ...
            parts = listOf(
                ...
                part("p-sbd-3", "Peso Muerto", "#244B3C", listOf(
                    ex("sbd3-ex1", "Peso Muerto Competitivo", "tren_inferior_peso_muerto_rumano",
        ...
        session = Session(
            ...
            parts = listOf(
                ...
                part("p-push-s-2", "Hombro", "#4A1942", listOf(
                    ex("ps2-ex1", "Press Militar con Mancuernas", "tren_superior_press_militar_pie_barra",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-pull-s-1", "Espalda", "#0F3D5E", listOf(
                    ...
                    ex("psp1-ex2", "Remo con Barra", "ultimo_remo_barra_esquina_1_brazo",
                ...
                part("p-pull-s-2", "Bíceps", "#5B2A86", listOf(
                    ex("psp2-ex1", "Curl con Barra EZ", "tren_superior_curl_biceps_barra_recta",
        ...
        session = Session(
            ...
            parts = listOf(
                ...
                part("p-ub-2", "Tirón", "#244B3C", listOf(
                    ex("ub2-ex1", "Remo con Barra", "ultimo_remo_barra_esquina_1_brazo",
                ...
                part("p-ub-3", "Brazos", "#5B2A86", listOf(
                    ex("ub3-ex1", "Curl con Barra EZ", "tren_superior_curl_biceps_barra_recta",
