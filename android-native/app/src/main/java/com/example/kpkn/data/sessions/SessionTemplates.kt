...
private val SESSION_TEMPLATES_BASE: List<SessionTemplate> = listOf(
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-push-1", "Pecho + Hombros", "#1B4965", listOf(
                    ...
                    ex("p1-ex4", "Aperturas en Máquina Pec Deck", "tren_superior_aperturas_pec_deck",
                        nSets("p1e4", 2, 12, 8.0), restTime = 90, damageProfile = DamageProfile.SQUEEZE),
                )),
                part("p-push-2", "Tríceps", "#1F3A2E", listOf(
                    ex("p3-ex1", "Extensión de Tríceps en Polea Alta", "triceps_pushdown_polea",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-pull-1", "Tirón principal", "#0F3D5E", listOf(
                    ex("pu1-ex1", "Jalón Neutro en Polea", "back_jalon_neutro_polea",
                        nSets("pu1e1", 2, 10, 7.5), restTime = 120),
                    ex("pu1-ex2", "Remo con Pecho Apoyado con Mancuernas", "back_remo_pecho_apoyado_mancuernas",
                        nSets("pu1e2", 2, 8, 7.5), restTime = 150),
                    ex("pu1-ex3", "Curl Predicador con Barra EZ", "biceps_curl_predicador_supino_barra_ez",
                        nSets("pu1e3", 2, 10, 8.5), restTime = 90, damageProfile = DamageProfile.STRETCH),
                    ex("pu1-ex4", "Face Pull en Polea", "deltoides_face_pull_polea",
                        nSets("pu1e4", 2, 15, 8.0), restTime = 90),
                    ex("pu1-ex5", "Pullover en Polea Alta", "back_pullover_polea",
                        nSets("pu1e5", 2, 12, 8.0), restTime = 90),
                    ex("pu1-ex6", "Curl Martillo de Pie con Mancuernas", "biceps_curl_de_pie_martillo_mancuernas",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-lq-1", "Compuestos", "#7F1D1D", listOf(
                    ex("lq1-ex1", "Sentadilla Trasera Barra Alta con Barra Recta", "quads_sentadilla_trasera_barra_alta",
                        nSets("lq1e1", 3, 6, 8.0), restTime = 180, damageProfile = DamageProfile.STRETCH),
                    ex("lq1-ex2", "Peso Muerto Rumano con Barra Recta", "hams_peso_muerto_rumano_barra_recta",
                        nSets("lq1e2", 2, 8, 8.0), restTime = 150, damageProfile = DamageProfile.STRETCH),
                )),
                part("p-lq-2", "Aislamientos", "#1E3A8A", listOf(
                    ex("lq2-ex1", "Extensión de Cuádriceps en Máquina", "quads_extension_cuadriceps_maquina",
                    ...
                    ex("lq2-ex3", "Aducción de Cadera Sentado en Máquina", "adductors_aduccion_cadera_sentado_maquina",
                        nSets("lq2e3", 2, 12, 8.5), restTime = 75),
                    ex("lq2-ex4", "Elevación de Talones de Pie en Máquina", "calves_elevacion_talones_de_pie_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-lh-1", "Compuestos", "#244B3C", listOf(
                    ex("lh1-ex1", "Peso Muerto Rumano con Barra Recta", "hams_peso_muerto_rumano_barra_recta",
                        nSets("lh1e1", 3, 8, 8.0), restTime = 150, damageProfile = DamageProfile.STRETCH),
                    ex("lh1-ex2", "Prensa de Piernas a 45º en Máquina", "quads_prensa_piernas_45_maquina",
                        nSets("lh1e2", 2, 10, 7.0), restTime = 120),
                    ex("lh1-ex3", "Hip Thrust con Barra Recta", "glutes_hip_thrust_barra_recta",
                        nSets("lh1e3", 2, 10, 8.0), restTime = 120, damageProfile = DamageProfile.SQUEEZE),
                )),
                part("p-lh-2", "Aislamientos", "#1B4965", listOf(
                    ex("lh2-ex1", "Curl Femoral de Pie en Máquina", "hams_curl_femoral_pie_maquina",
                        nSets("lh2e1", 2, 10, 8.5), restTime = 90, damageProfile = DamageProfile.STRETCH),
                    ex("lh2-ex2", "Aducción de Cadera Sentado en Máquina", "adductors_aduccion_cadera_sentado_maquina",
                        nSets("lh2e2", 2, 12, 8.5), restTime = 75),
                    ex("lh2-ex3", "Elevación de Talones de Pie en Máquina", "calves_elevacion_talones_de_pie_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-sbd-1", "Sentadilla", "#7F1D1D", listOf(
                    ex("sbd1-ex1", "Sentadilla Trasera Barra Alta con Barra Recta", "quads_sentadilla_trasera_barra_alta",
                ...
                part("p-sbd-3", "Peso Muerto", "#244B3C", listOf(
                    ex("sbd3-ex1", "Peso Muerto Convencional con Barra Recta", "hams_peso_muerto_convencional_barra_recta",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-lc-1", "Compuestos", "#7F1D1D", listOf(
                    ex("lc1-ex1", "Sentadilla Trasera Barra Alta con Barra Recta", "quads_sentadilla_trasera_barra_alta",
                        nSets("lc1e1", 2, 6, 8.0), restTime = 180, damageProfile = DamageProfile.STRETCH),
                    ex("lc1-ex2", "Peso Muerto Rumano Estilo Sumo con Barra Recta", "hams_peso_muerto_rumano_sumo_barra_recta",
                        nSets("lc1e2", 2, 8, 8.0), restTime = 150, damageProfile = DamageProfile.STRETCH),
                    ex("lc1-ex3", "Prensa de Piernas Horizontal en Máquina", "quads_prensa_piernas_horizontal_maquina",
                        nSets("lc1e3", 2, 10, 7.5), restTime = 120),
                )),
                part("p-lc-2", "Aislamientos", "#244B3C", listOf(
                    ex("lc2-ex1", "Curl Femoral Tumbado en Máquina", "hams_curl_femoral_tumbado_maquina",
                        nSets("lc2e1", 2, 12, 8.5), restTime = 90),
                    ex("lc2-ex2", "Extensión de Cuádriceps en Máquina", "quads_extension_cuadriceps_maquina",
                        nSets("lc2e2", 2, 12, 8.5), restTime = 90),
                    ex("lc2-ex3", "Aducción de Cadera Sentado en Máquina", "adductors_aduccion_cadera_sentado_maquina",
                        nSets("lc2e3", 2, 12, 8.5), restTime = 75),
                    ex("lc2-ex4", "Elevación de Talones Sentado en Máquina", "calves_elevacion_talones_sentado_maquina",
                        nSets("lc2e4", 2, 15, 8.5), restTime = 60),
                )),
            ),
        ),
    ),
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-gp-1", "Activación y Rango", "#4A1942", listOf(
                    ...
                    ex("gp1-ex2", "Curl Femoral Sentado en Máquina", "hams_curl_femoral_sentado_maquina",
                        nSets("gp1e2", 2, 12, 8.0), restTime = 90),
                    ex("gp1-ex3", "Hiperextensión a 45º", "glutes_hiperextension_45",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-dlp-1", "Peso Muerto", "#244B3C", listOf(
                    ex("dlp1-ex1", "Peso Muerto Convencional con Barra Recta", "hams_peso_muerto_convencional_barra_recta",
    ...
    SessionTemplate(
        ...
        session = Session(
            ...
            name = "T1 Sentadilla · GZCL",
            exercises = listOf(
                ex("gzs-ex1", "Sentadilla Trasera Barra Alta con Barra Recta", "quads_sentadilla_trasera_barra_alta",
    ...
    SessionTemplate(
        ...
        session = Session(
            ...
            name = "T1 Peso Muerto · GZCL",
            exercises = listOf(
                ex("gzd-ex1", "Peso Muerto Convencional con Barra Recta", "hams_peso_muerto_convencional_barra_recta",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-aca-1", "Empujes Pierna + Torso", "#7F1D1D", listOf(
                    ...
                    ex("aca1-ex4", "Press de Hombros Sentado en Máquina", "deltoides_press_hombros_sentado_maquina",
                        nSets("aca1e4", 2, 10, 7.5), restTime = 90),
                    ex("aca1-ex5", "Aperturas en Máquina Pec Deck", "tren_superior_aperturas_pec_deck",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-pca-1", "Cadena Posterior Pesada", "#244B3C", listOf(
                    ex("pca1-ex1", "Peso Muerto Convencional con Barra Recta", "hams_peso_muerto_convencional_barra_recta",
                    ...
                    ex("pca1-ex3", "Hip Thrust con Barra Recta", "glutes_hip_thrust_barra_recta",
                        nSets("pca1e3", 2, 10, 8.0), restTime = 120),
                )),
                part("p-pca-2", "Aislamiento y Tracción", "#0F3D5E", listOf(
                    ex("pca2-ex1", "Jalón Neutro en Polea", "back_jalon_neutro_polea",
                        nSets("pca2e1", 2, 10, 7.5), restTime = 120),
                    ex("pca2-ex2", "Curl Femoral Sentado en Máquina", "hams_curl_femoral_sentado_maquina",
                        nSets("pca2e2", 2, 12, 8.5), restTime = 75),
                    ex("pca2-ex3", "Face Pull en Polea", "deltoides_face_pull_polea",
        ...
        session = Session(
            ...
            parts = listOf(
                ...
                part("p-ad-2", "Estabilidad", "#244B3C", listOf(
                    ...
                    ex("ad2-ex2", "Aducción de Cadera Sentado en Máquina", "adductors_aduccion_cadera_sentado_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-pb-1", "Pecho + Hombros", "#1B4965", listOf(
                    ...
                    ex("pb1-ex5", "Aperturas en Máquina Pec Deck", "tren_superior_aperturas_pec_deck",
                        nSets("pbe5", 2, 12, 7.5), restTime = 75),
                    ex("pb1-ex6", "Extensión de Tríceps Overhead en Máquina", "triceps_overhead_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-pa-1", "Empuje", "#1B4965", listOf(
                    ...
                    ex("pa1-ex5", "Aperturas Inclinadas con Mancuernas", "tren_superior_aperturas_inclinadas_mancuernas",
                        nSets("pae5", 2, 12, 8.0), restTime = 90),
                    ex("pa1-ex6", "Extensión de Tríceps Overhead con Mancuerna", "triceps_overhead_mancuerna",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-plb-1", "Tirón guiado", "#0F3D5E", listOf(
                    ...
                    ex("plb1-ex4", "Pullover en Máquina", "back_pullover_maquina",
                        nSets("plbe4", 2, 12, 7.5), restTime = 75),
                    ex("plb1-ex5", "Curl Martillo Predicador con Mancuernas", "biceps_curl_predicador_martillo_mancuernas",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-pla-1", "Tirón", "#0F3D5E", listOf(
                    ...
                    ex("pla1-ex6", "Pullover en Polea Alta", "back_pullover_polea",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-lb-1", "Máquinas", "#7F1D1D", listOf(
                    ex("lb1-ex1", "Prensa de Piernas a 45º en Máquina", "quads_prensa_piernas_45_maquina",
                        nSets("lbe1", 2, 12, 7.0), restTime = 120),
                    ex("lb1-ex2", "Hip Thrust en Máquina", "glutes_hip_thrust_maquina",
                    ...
                    ex("lb1-ex4", "Curl Femoral Sentado en Máquina", "hams_curl_femoral_sentado_maquina",
                        nSets("lbe4", 2, 12, 7.5), restTime = 75),
                    ex("lb1-ex5", "Aducción de Cadera Sentado en Máquina", "adductors_aduccion_cadera_sentado_maquina",
                        nSets("lbe5", 2, 12, 7.5), restTime = 75),
                    ex("lb1-ex6", "Elevación de Talones de Pie en Máquina", "calves_elevacion_talones_de_pie_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-la-1", "Compuestos", "#7F1D1D", listOf(
                    ex("la1-ex1", "Sentadilla Trasera Barra Alta con Barra Recta", "quads_sentadilla_trasera_barra_alta",
                        nSets("lae1", 3, 5, 8.5), restTime = 180),
                    ex("la1-ex2", "Peso Muerto Rumano con Barra Recta", "hams_peso_muerto_rumano_barra_recta",
                        nSets("lae2", 2, 8, 8.5), restTime = 150),
                    ex("la1-ex3", "Sentadilla Búlgara Frontal con Mancuernas", "quads_sentadilla_bulgara_frontal_mancuernas",
                        nSets("lae3", 2, 8, 8.0), restTime = 120),
                )),
                part("p-la-2", "Aislamientos", "#244B3C", listOf(
                    ex("la2-ex1", "Curl Femoral Tumbado en Máquina", "hams_curl_femoral_tumbado_maquina",
                        nSets("lae4", 2, 10, 8.5), restTime = 90),
                    ex("la2-ex2", "Extensión de Cuádriceps Unilateral en Máquina", "quads_extension_cuadriceps_maquina_unilateral",
                        nSets("lae5", 2, 12, 8.5), restTime = 75),
                    ex("la2-ex3", "Aducción de Cadera Sentado en Máquina", "adductors_aduccion_cadera_sentado_maquina",
                        nSets("lae6", 2, 12, 8.5), restTime = 75),
                    ex("la2-ex4", "Elevación de Talones de Pie Unilateral en Máquina", "calves_elevacion_talones_de_pie_unilateral_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-fba-1", "Pierna", "#7F1D1D", listOf(
                    ...
                    ex("fba1-ex2", "Peso Muerto Rumano con Barra Recta", "hams_peso_muerto_rumano_barra_recta",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-lqs-1", "Short lower", "#7F1D1D", listOf(
                    ex("lqs1-ex1", "Prensa de Piernas Horizontal en Máquina", "quads_prensa_piernas_horizontal_maquina",
                        nSets("lqse1", 2, 10, 7.5), restTime = 120),
                    ex("lqs1-ex2", "Peso Muerto Rumano con Barra Recta", "hams_peso_muerto_rumano_barra_recta",
                        nSets("lqse2", 2, 8, 8.0), restTime = 120),
                    ex("lqs1-ex3", "Extensión de Cuádriceps en Máquina", "quads_extension_cuadriceps_maquina",
                        nSets("lqse3", 2, 12, 8.5), restTime = 75),
                    ex("lqs1-ex4", "Curl Femoral Sentado en Máquina", "hams_curl_femoral_sentado_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-lgs-1", "Short glute", "#4A1942", listOf(
                    ex("lgs1-ex1", "Hip Thrust con Barra Recta", "glutes_hip_thrust_barra_recta",
                        nSets("lgse1", 2, 10, 8.0), restTime = 120),
                    ex("lgs1-ex2", "Peso Muerto Rumano con Barra Recta", "hams_peso_muerto_rumano_barra_recta",
                        nSets("lgse2", 2, 8, 8.0), restTime = 120),
                    ex("lgs1-ex3", "Patada de Glúteo en Máquina", "glutes_patada_gluteo_maquina",
                        nSets("lgse3", 2, 15, 8.5), restTime = 75),
                    ex("lgs1-ex4", "Curl Femoral Tumbado en Máquina", "hams_curl_femoral_tumbado_maquina",
                        nSets("lgse4", 2, 12, 8.5), restTime = 75),
                    ex("lgs1-ex5", "Elevación de Talones Sentado en Máquina", "calves_elevacion_talones_sentado_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-lhs-1", "Short hams", "#244B3C", listOf(
                    ex("lhs1-ex1", "Peso Muerto Rumano con Barra Recta", "hams_peso_muerto_rumano_barra_recta",
                        nSets("lhse1", 2, 8, 8.0), restTime = 150),
                    ex("lhs1-ex2", "Hip Thrust en Máquina", "glutes_hip_thrust_maquina",
                        nSets("lhse2", 2, 10, 8.0), restTime = 120),
                    ex("lhs1-ex3", "Curl Femoral de Pie en Máquina", "hams_curl_femoral_pie_maquina",
                        nSets("lhse3", 2, 10, 8.5), restTime = 90),
                    ex("lhs1-ex4", "Elevación de Talones de Pie en Máquina", "calves_elevacion_talones_de_pie_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-lg-1", "Compuestos glúteo", "#4A1942", listOf(
                    ex("lg1-ex1", "Hip Thrust con Barra Recta", "glutes_hip_thrust_barra_recta",
                        nSets("lge1", 3, 10, 8.0), restTime = 120),
                    ex("lg1-ex2", "Peso Muerto Rumano con Barra Recta", "hams_peso_muerto_rumano_barra_recta",
                        nSets("lge2", 2, 8, 8.0), restTime = 150),
                )),
                part("p-lg-2", "Aislamientos", "#244B3C", listOf(
                    ex("lg2-ex1", "Patada de Glúteos en Polea", "glutes_patada_gluteo_polea",
                        nSets("lge3", 2, 12, 8.5), restTime = 75),
                    ex("lg2-ex2", "Curl Femoral Sentado en Máquina", "hams_curl_femoral_sentado_maquina",
                        nSets("lge4", 2, 12, 8.5), restTime = 90),
                    ex("lg2-ex3", "Aducción de Cadera Sentado en Máquina", "adductors_aduccion_cadera_sentado_maquina",
                        nSets("lge5", 2, 12, 8.5), restTime = 75),
                    ex("lg2-ex4", "Elevación de Talones de Pie en Máquina", "calves_elevacion_talones_de_pie_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-ucb-1", "Pecho máquina", "#1B4965", listOf(
                    ...
                    ex("ucb1-ex4", "Aperturas en Máquina Pec Deck", "tren_superior_aperturas_pec_deck",
                        nSets("ucbe4", 2, 12, 7.5), restTime = 75),
                    ex("ucb1-ex5", "Extensión de Tríceps Overhead en Máquina", "triceps_overhead_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-uci-1", "Pecho", "#1B4965", listOf(
                    ...
                    ex("uci1-ex5", "Extensión de Tríceps Overhead en Polea", "triceps_overhead_polea",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-uca-1", "Pecho avanzado", "#1B4965", listOf(
                    ...
                    ex("uca1-ex4", "Aperturas Inclinadas con Mancuernas", "tren_superior_aperturas_inclinadas_mancuernas",
                        nSets("ucae4", 2, 12, 8.0), restTime = 90),
                    ex("uca1-ex5", "Patada de Tríceps en Polea", "triceps_patada_polea",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-ubb-1", "Tirón máquina", "#0F3D5E", listOf(
                    ...
                    ex("ubb1-ex4", "Pullover en Máquina", "back_pullover_maquina",
                        nSets("ubbe4", 2, 12, 7.5), restTime = 75),
                    ex("ubb1-ex5", "Face Pull en Polea", "deltoides_face_pull_polea",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-ubi-1", "Espalda", "#0F3D5E", listOf(
                    ...
                    ex("ubi1-ex4", "Pullover en Polea Alta", "back_pullover_polea",
                        nSets("ubie4", 2, 12, 8.0), restTime = 90),
                    ex("ubi1-ex5", "Face Pull en Polea", "deltoides_face_pull_polea",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-uba-1", "Espalda avanzada", "#0F3D5E", listOf(
                    ex("uba1-ex1", "Dominadas Pronas", "back_dominadas_pronas",
                        nSets("ubae1", 2, 6, 8.5), restTime = 150),
                    ex("uba1-ex2", "Remo Seal con Mancuernas", "back_remo_seal_mancuernas",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-udb-1", "Delts máquina", "#4A1942", listOf(
                    ex("udb1-ex1", "Press de Hombros Sentado en Máquina", "deltoides_press_hombros_sentado_maquina",
                        nSets("udbe1", 2, 10, 7.0), restTime = 90),
                    ex("udb1-ex2", "Elevaciones Laterales de Pie en Máquina", "deltoides_elevaciones_laterales_de_pie_maquina",
                        nSets("udbe2", 2, 12, 7.5), restTime = 60),
                    ex("udb1-ex3", "Extensión de Tríceps Overhead en Máquina", "triceps_overhead_maquina",
                        nSets("udbe3", 2, 12, 7.5), restTime = 75),
                    ex("udb1-ex4", "Elevaciones Laterales Sentado en Máquina", "deltoides_elevaciones_laterales_sentado_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-udi-1", "Delts", "#4A1942", listOf(
                    ex("udi1-ex1", "Press de Hombros Sentado con Barra Recta", "deltoides_press_hombros_sentado_barra_recta",
                        nSets("udie1", 2, 8, 7.5), restTime = 120),
                    ex("udi1-ex2", "Elevaciones Laterales de Pie en Polea", "deltoides_elevaciones_laterales_de_pie_polea",
                        nSets("udie2", 2, 12, 8.5), restTime = 60),
                    ex("udi1-ex3", "Extensión de Tríceps en Polea Alta", "triceps_pushdown_polea",
                        nSets("udie3", 2, 12, 8.5), restTime = 75),
                    ex("udi1-ex4", "Face Pull en Polea", "deltoides_face_pull_polea",
                        nSets("udie4", 2, 15, 8.0), restTime = 75),
                    ex("udi1-ex5", "Patada de Tríceps en Polea", "triceps_patada_polea",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-uda-1", "Delts avanzado", "#4A1942", listOf(
                    ex("uda1-ex1", "Press Militar de Pie con Barra Recta", "deltoides_press_militar_de_pie_barra_recta",
                        nSets("udae1", 3, 5, 8.5), restTime = 150),
                    ex("uda1-ex2", "Elevaciones Laterales Super ROM con Mancuernas", "deltoides_elevaciones_laterales_super_rom_mancuernas",
                        nSets("udae2", 2, 12, 8.0), restTime = 60),
                    ex("uda1-ex3", "Extensión de Tríceps Overhead con Mancuerna", "triceps_overhead_mancuerna",
                        nSets("udae3", 2, 10, 8.0), restTime = 75),
                    ex("uda1-ex4", "Face Pull en Polea", "deltoides_face_pull_polea",
                        nSets("udae4", 2, 15, 8.0), restTime = 75),
                    ex("uda1-ex5", "Patada de Tríceps en Polea", "triceps_patada_polea",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-uab-1", "Brazos máquina", "#5B2A86", listOf(
                    ex("uab1-ex1", "Curl Predicador en Máquina", "biceps_curl_predicador_supino_maquina",
                        nSets("uabe1", 2, 12, 7.5), restTime = 75),
                    ex("uab1-ex2", "Extensión de Tríceps Overhead en Máquina", "triceps_overhead_maquina",
                        nSets("uabe2", 2, 12, 7.5), restTime = 75),
                    ex("uab1-ex3", "Curl Martillo Predicador con Mancuernas", "biceps_curl_predicador_martillo_mancuernas",
                        nSets("uabe3", 2, 12, 7.5), restTime = 60),
                    ex("uab1-ex4", "Patada de Tríceps en Polea", "triceps_patada_polea",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-uai-1", "Brazos", "#5B2A86", listOf(
                    ex("uai1-ex1", "Curl en Banco Inclinado con Mancuernas", "biceps_curl_inclinado_supino_mancuernas",
                        nSets("uaie1", 2, 10, 8.5), restTime = 75),
                    ex("uai1-ex2", "Extensión de Tríceps Overhead con Barra EZ", "triceps_overhead_barra_ez",
                        nSets("uaie2", 2, 12, 8.5), restTime = 75),
                    ex("uai1-ex3", "Curl Concentrado con Mancuernas", "biceps_curl_concentrado_supino_mancuernas",
                        nSets("uaie3", 2, 12, 8.5), restTime = 60),
                    ex("uai1-ex4", "Patada de Tríceps con Mancuerna", "triceps_patada_mancuerna",
                        nSets("uaie4", 2, 12, 8.5), restTime = 75),
                    ex("uai1-ex5", "Curl Predicador con Barra EZ", "biceps_curl_predicador_supino_barra_ez",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-uaa-1", "Brazos avanzado", "#5B2A86", listOf(
                    ex("uaa1-ex1", "Curl Bayesian con Mancuernas", "biceps_curl_bayesian_supino_mancuernas",
                        nSets("uaae1", 3, 10, 8.5), restTime = 75),
                    ex("uaa1-ex2", "Extensión de Tríceps Overhead con Mancuerna", "triceps_overhead_mancuerna",
                        nSets("uaae2", 2, 10, 8.5), restTime = 75),
                    ex("uaa1-ex3", "Curl Martillo de Pie con Mancuernas", "biceps_curl_de_pie_martillo_mancuernas",
                        nSets("uaae3", 2, 12, 8.5), restTime = 60),
                    ex("uaa1-ex4", "Patada de Tríceps en Polea", "triceps_patada_polea",
                        nSets("uaae4", 2, 12, 8.5), restTime = 60),
                    ex("uaa1-ex5", "Curl Predicador con Barra EZ", "biceps_curl_predicador_supino_barra_ez",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-cs-1", "Pecho", "#1B4965", listOf(
                    ...
                    ex("cs1-ex4", "Cruce de Poleas Altas", "tren_superior_cruce_poleas_altas",
                        nSets("cse4", 2, 12, 8.5), restTime = 90),
                    ex("cs1-ex5", "Extensión de Tríceps Overhead en Polea", "triceps_overhead_polea",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-bs-1", "Tirón", "#0F3D5E", listOf(
                    ex("bs1-ex1", "Jalón Neutro en Polea", "back_jalon_neutro_polea",
                        nSets("bse1", 3, 8, 8.5), restTime = 150),
                    ex("bs1-ex2", "Remo con Pecho Apoyado con Mancuernas", "back_remo_pecho_apoyado_mancuernas",
                        nSets("bse2", 2, 8, 8.5), restTime = 150),
                    ex("bs1-ex3", "Curl Predicador con Barra EZ", "biceps_curl_predicador_supino_barra_ez",
                        nSets("bse3", 2, 10, 8.5), restTime = 90),
                    ex("bs1-ex4", "Face Pull en Polea", "deltoides_face_pull_polea",
                        nSets("bse4", 2, 15, 8.0), restTime = 75),
                    ex("bs1-ex5", "Pullover en Polea Alta", "back_pullover_polea",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-ls-1", "Compuestos", "#7F1D1D", listOf(
                    ex("ls1-ex1", "Sentadilla Trasera Barra Alta con Barra Recta", "quads_sentadilla_trasera_barra_alta",
                        nSets("lse1", 3, 5, 8.5), restTime = 210),
                    ex("ls1-ex2", "Peso Muerto Rumano con Barra Recta", "hams_peso_muerto_rumano_barra_recta",
                        nSets("lse2", 2, 8, 8.5), restTime = 180),
                )),
                part("p-ls-2", "Aislamientos", "#1E3A8A", listOf(
                    ex("ls2-ex1", "Extensión de Cuádriceps en Máquina", "quads_extension_cuadriceps_maquina",
                        nSets("lse3", 2, 12, 8.5), restTime = 90),
                    ex("ls2-ex2", "Curl Femoral Sentado en Máquina", "hams_curl_femoral_sentado_maquina",
                        nSets("lse4", 2, 12, 8.5), restTime = 90),
                    ex("ls2-ex3", "Aducción de Cadera Sentado en Máquina", "adductors_aduccion_cadera_sentado_maquina",
                        nSets("lse5", 2, 12, 8.5), restTime = 75),
                    ex("ls2-ex4", "Elevación de Talones de Pie en Máquina", "calves_elevacion_talones_de_pie_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-uv-1", "Empuje / Tirón", "#1B4965", listOf(
                    ...
                    ex("uv1-ex3", "Press de Hombros Sentado en Máquina", "deltoides_press_hombros_sentado_maquina",
                        nSets("uve3", 2, 10, 8.0), restTime = 120),
                    ex("uv1-ex4", "Remo con Pecho Apoyado con Mancuernas", "back_remo_pecho_apoyado_mancuernas",
                        nSets("uve4", 2, 10, 8.0), restTime = 120),
                    ex("uv1-ex5", "Extensión de Tríceps Overhead en Polea", "triceps_overhead_polea",
                        nSets("uve5", 2, 12, 8.5), restTime = 75),
                    ex("uv1-ex6", "Curl Martillo de Pie con Mancuernas", "biceps_curl_de_pie_martillo_mancuernas",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-lf-1", "Fuerza", "#7F1D1D", listOf(
                    ex("lf1-ex1", "Sentadilla Trasera Barra Alta con Barra Recta", "quads_sentadilla_trasera_barra_alta",
                        nSets("lfe1", 4, 4, 8.0), restTime = 240),
                    ex("lf1-ex2", "Peso Muerto Rumano con Barra Recta", "hams_peso_muerto_rumano_barra_recta",
                        nSets("lfe2", 3, 5, 8.0), restTime = 210),
                )),
                part("p-lf-2", "Soporte", "#1E3A8A", listOf(
                    ex("lf2-ex1", "Extensión de Cuádriceps en Máquina", "quads_extension_cuadriceps_maquina",
                        nSets("lfe3", 2, 10, 8.0), restTime = 90),
                    ex("lf2-ex2", "Curl Femoral Sentado en Máquina", "hams_curl_femoral_sentado_maquina",
                        nSets("lfe4", 2, 10, 8.0), restTime = 90),
                    ex("lf2-ex3", "Aducción de Cadera Sentado en Máquina", "adductors_aduccion_cadera_sentado_maquina",
                        nSets("lfe5", 2, 12, 8.0), restTime = 75),
                    ex("lf2-ex4", "Elevación de Talones de Pie en Máquina", "calves_elevacion_talones_de_pie_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-da-1", "Full ligero", "#244B3C", listOf(
                    ...
                    ex("da1-ex3", "Sentadilla Trasera Barra Alta con Barra Recta", "quads_sentadilla_trasera_barra_alta",
                        nSets("dae3", 2, 8, 6.5), restTime = 150),
                    ex("da1-ex4", "Elevaciones Laterales de Pie con Mancuernas", "deltoides_elevaciones_laterales_de_pie_mancuernas",
                        nSets("dae4", 2, 12, 6.5), restTime = 60),
                    ex("da1-ex5", "Elevación de Talones de Pie en Máquina", "calves_elevacion_talones_de_pie_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-td-1", "Densidad", "#1B4965", listOf(
                    ...
                    ex("td1-ex3", "Elevaciones Laterales de Pie con Mancuernas", "deltoides_elevaciones_laterales_de_pie_mancuernas",
                        nSets("tde3", 2, 15, 8.0), restTime = 45),
                    ex("td1-ex4", "Face Pull en Polea", "deltoides_face_pull_polea",
                        nSets("tde4", 2, 15, 8.0), restTime = 45),
                    ex("td1-ex5", "Patada de Tríceps en Polea", "triceps_patada_polea",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-pe-1", "Bisagra", "#4A1942", listOf(
                    ex("pe1-ex1", "Peso Muerto Rumano con Barra Recta", "hams_peso_muerto_rumano_barra_recta",
                        nSets("pee1", 3, 6, 8.5), restTime = 180),
                    ex("pe1-ex2", "Curl Femoral Sentado en Máquina", "hams_curl_femoral_sentado_maquina",
                        nSets("pee2", 3, 10, 8.5), restTime = 90),
                )),
                part("p-pe-2", "Glúteo y gemelos", "#7F1D1D", listOf(
                    ex("pe2-ex1", "Hip Thrust con Barra Recta", "glutes_hip_thrust_barra_recta",
                        nSets("pee3", 3, 8, 8.5), restTime = 120),
                    ex("pe2-ex2", "Aducción de Cadera Sentado en Máquina", "adductors_aduccion_cadera_sentado_maquina",
                        nSets("pee4", 2, 12, 8.0), restTime = 75),
                    ex("pe2-ex3", "Elevación de Talones de Pie en Máquina", "calves_elevacion_talones_de_pie_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-ae-1", "Anterior", "#1E3A8A", listOf(
                    ...
                    ex("ae1-ex4", "Aducción de Cadera Sentado en Máquina", "adductors_aduccion_cadera_sentado_maquina",
                        nSets("aee4", 2, 12, 8.0), restTime = 75),
                    ex("ae1-ex5", "Elevación de Talones de Pie en Máquina", "calves_elevacion_talones_de_pie_maquina",
        ...
        session = Session(
            ...
            parts = listOf(
                part("p-fd-1", "Full", "#244B3C", listOf(
                    ...
                    ex("fd1-ex4", "Peso Muerto Rumano con Barra Recta", "hams_peso_muerto_rumano_barra_recta",
                        nSets("fde4", 2, 8, 8.0), restTime = 150),
                    ex("fd1-ex5", "Elevaciones Laterales de Pie con Mancuernas", "deltoides_elevaciones_laterales_de_pie_mancuernas",
                        nSets("fde5", 2, 12, 8.0), restTime = 60),
                    ex("fd1-ex6", "Elevación de Talones de Pie en Máquina", "calves_elevacion_talones_de_pie_maquina",
                        nSets("fde6", 2, 12, 8.5), restTime = 45),
                )),
            ),
        ),
    ),
