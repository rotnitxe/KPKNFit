...
val TRAINING_CONCEPTS_DATABASE: List<TrainingConcept> = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("intensidad", "frecuencia", "fatiga-sistemica", "rir", "fallo-muscular"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("rir", "rpe", "fallo-muscular", "volumen-entrenamiento", "tension-mecanica"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("volumen-entrenamiento", "fatiga-sistemica", "dano-muscular"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("rpe", "fallo-muscular", "intensidad", "volumen-entrenamiento"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("rir", "fallo-muscular", "intensidad", "fatiga-sistemica"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("rir", "rpe", "fatiga-sistemica", "dano-muscular", "tension-mecanica"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("volumen-entrenamiento", "intensidad", "fallo-muscular", "dano-muscular"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("fase-excentrica", "fatiga-sistemica", "tension-mecanica", "frecuencia"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("perfil-resistencia", "rom", "fase-excentrica", "fuerza"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("tension-mecanica", "dano-muscular", "fallo-muscular", "intensidad"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("tension-mecanica", "fase-excentrica", "perfil-resistencia", "carga-axial"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("rom", "tension-mecanica", "poleas", "fuerza"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("fase-concentrica", "isometria", "dano-muscular", "tension-mecanica", "rom"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("fase-excentrica", "isometria", "tension-mecanica", "explosividad"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("fase-excentrica", "fase-concentrica", "tension-mecanica", "pliometria"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("explosividad", "elasticidad", "fase-excentrica", "fase-concentrica"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("pesos-libres", "maquinas", "tension-mecanica", "rom"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("maquinas", "poleas", "tension-mecanica", "carga-axial"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("pesos-libres", "poleas", "perfil-resistencia", "fallo-muscular"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("pesos-libres", "maquinas", "perfil-resistencia", "tension-mecanica"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("intensidad", "explosividad", "tension-mecanica", "perfil-resistencia"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("fuerza", "pliometria", "elasticidad", "fase-concentrica"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("pliometria", "explosividad", "fase-excentrica", "fase-concentrica"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("fuerza", "estres-metabolico", "fatiga-sistemica", "volumen-entrenamiento"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("volumen-entrenamiento", "intensidad", "tension-mecanica", "frecuencia"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("fatiga-sistemica", "sobrecarga-progresiva", "volumen-entrenamiento"),
        examples = listOf(
    ...
    TrainingConcept(
        ...
        relatedConcepts = listOf("sobrecarga-progresiva", "fuerza", "rom", "intensidad"),
        examples = listOf(
...
fun searchConcepts(query: String): List<TrainingConcept> {
    ...
    return TRAINING_CONCEPTS_DATABASE.filter { concept ->
        concept.name.lowercase().contains(q) ||
            ...
            concept.definition.lowercase().contains(q) ||
