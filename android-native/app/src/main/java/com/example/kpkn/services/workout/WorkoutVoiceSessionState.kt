...
sealed class VoiceSessionCommand {
    ...
    data object SkipCardioBlock : VoiceSessionCommand()
    data object PauseCardio : VoiceSessionCommand()
    data object ResumeCardio : VoiceSessionCommand()
    data object QueryCardioStatus : VoiceSessionCommand()
